...
> = {
  ...
  "bizrea-maeda-nako-interview": {
    ...
    body: (
      <>
        <p>
          この度、女優・モデル・インフルエンサー・イラストレーターとして幅広く活躍されている、まえだなこさんに、Bizreaの取材をさせていただきました！
        </p>
        <p>
          さまざまな分野で活動を続けるまえだなこさん。今回の取材では、これまでの歩みや現在の活動、仕事に対する想いなど、さまざまなお話を伺いました。
        </p>
        <p>
          一つの肩書きにとらわれず、自分らしく挑戦を続ける姿勢や、活動を通して大切にしていることなど、まえだなこさんならではのお話が詰まった取材となっています。
        </p>
        <p>取材内容の詳細は、今後Bizreaにて公開予定です。</p>
        <p>
          どんな想いやエピソードを語ってくださったのか、ぜひ公開を楽しみにお待ちください！
        </p>
        <p>
          Singでは、これからもさまざまな分野で活躍する方々にスポットを当て、その人ならではの想いや魅力を発信してまいります。
        </p>
      </>
    ),
  },
  "bizrea-nobodyknows-interview": {
    date: "2026-08-31",
    category: "ブログ",
    ...
    body: (
      <>
        <p>
          この度、nobodyknows+のメンバーとして活躍されている、ノリ・ダ・ファンキーシビレサスさんに、グループ会社「Bizrea」の取材をさせていただきました！
        </p>
        <p>
          今回の取材では、これまでの活動や経験について、さまざまなお話を伺う貴重な機会となりました。
        </p>
        <p>取材内容は、今後Bizreaにて公開予定です。</p>
        <p>どんなお話を聞くことができたのか、ぜひ公開を楽しみにお待ちください！</p>
        <p>
          Singでは、これからもさまざまな分野で活躍されている方との出会いや、その人ならではの想い・考え方に触れる機会を大切にしながら、皆さまに楽しんでいただける情報を発信してまいります。
        </p>
        <p>今後の更新もぜひチェックしてください！</p>
      </>
    ),
  },
  "sabo-haru-interview": {
    ...
    body: (
      <>
        <p>
          この度、春日井市の魅力を発信するインフルエンサー「サボはる」さんを、月刊Sing春日井で取材させていただくことが決定しました！
        </p>
        <p>
          サボはるさんは、Instagramを中心に、春日井市のお店やグルメ、地域のスポットなど、“春日井の魅力”を幅広く発信されています。
        </p>
        <p>
          地域に暮らす方はもちろん、「こんなお店があったんだ！」「春日井に行ってみたい！」と思えるような情報を届けながら、春日井のまちを盛り上げているサボはるさん。
        </p>
        <p>
          今回の取材では、活動を始めたきっかけや、情報発信を続ける中で感じている春日井の魅力、これからの活動への想いなど、さまざまなお話を伺う予定です。
        </p>
        <p>
          月刊Sing春日井では、春日井で活躍する「人」や「お店」、「企業」にスポットを当て、その背景にある想いや魅力を地域のみなさまへお届けしていきます。
        </p>
        <p>サボはるさんから、どんなお話を聞くことができるのか。</p>
        <p>今後の月刊Sing春日井での掲載を、ぜひ楽しみにお待ちください！</p>
      </>
    ),
  },
  ...
  "kenko-keiei-2026-forum": {
    ...
    body: (
      <>
        <p>
          このたび、弊社は「健康経営優良法人認定2026」に認定され、その祝賀フォーラムに参加いたしました。
        </p>
        <p>
          春日井市では、今年度88社が健康経営優良法人の認定を取得しており、そのうち39社が本フォーラムに参加しました。会場では、各企業が取り組んでいる健康経営施策の紹介や事例発表が行われ、社員の健康増進に向けた具体的な取り組みについて、多くの学びを得る機会となりました。
        </p>
        <p>
          特に印象的だったのは、単なる福利厚生の充実にとどまらず、従業員一人ひとりの働きがいや生産性向上につながる取り組みを実践されている企業が多かった点です。健康診断受診率の向上、メンタルヘルス対策、運動機会の創出、コミュニケーション活性化施策など、多様な取り組みが紹介され、弊社にとっても今後の施策検討における大きなヒントとなりました。
        </p>
        <p>
          また、参加企業同士の交流の場では、実際の運用における課題や工夫について意見交換を行うことができ、大変有意義な時間となりました。同じ地域で健康経営に取り組む企業同士のつながりの重要性も改めて実感いたしました。
        </p>
        <p>
          今回の認定はゴールではなく、今後のさらなる取り組みのスタートと捉えています。弊社では引き続き、従業員の健康保持・増進を重要な経営課題と位置づけ、より働きやすく、活力ある職場環境づくりを推進してまいります。
        </p>
        <p>
          今後も株式会社Singは、社員とそのご家族、そして地域社会にとって価値ある企業であり続けるため、健康経営に積極的に取り組んでまいります。
        </p>
      </>
    ),
  },
  ...
  renewal: {
    ...
    body: (
      <>
        ...
        <h3>2. サービス紹介の充実</h3>
        <p>
          「ツナゲル」「Singメディア」の2つのサービスについて、それぞれの特長や導入メリットをより詳しくご紹介しています。採用から定着・活躍まで、一気通貫で支援するSingの強みをご覧ください。
        </p>
